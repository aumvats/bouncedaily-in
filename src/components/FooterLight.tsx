...
import { siteConfig, lightNavLinks, lightFooterLinks } from "@/lib/data";
        ...
        <div className="grid md:grid-cols-4 gap-12 lg:gap-16">
          ...
          <div className="md:col-span-1">
            ...
            <p className="mt-4 text-sm text-muted leading-relaxed max-w-xs">
              Building India&apos;s electric last-mile infrastructure. One rider,
              one swap, one city at a time.
            </p>
            {/* Social icons */}
